...
if (isset($_GET['confirm'])) {
    ...
    } elseif ($_GET['action']=="column_create" || $_GET['action']=="column_delete" || $_GET['action']=="column_edit" || $_GET['action']=="index_create" || $_GET['action']=="index_delete" || $_GET['action']=="trigger_delete" || $_GET['action']=="trigger_create") {
...
if (isset($_GET['action']) && !isset($_GET['confirm'])) {
    ...
    //- Row actions
        ...
        case "row_view":
            ...
            } elseif ($rowCount>0) {//no rows - do nothing
