...
<br />
<h1><a target="commons" href="<?= $media['url'] ?>"><?= Tools::stripPrefix($media['title']) ?></a></h1>
<br />
<br />
<p><?= ($media['imagedescription']) ?></p>
<p><em>by:</em> <b><?= ($media['artist'] ? $media['artist'] : 'unknown') ?></b>
<?php
...
<p>
    <em>View this file on:</em>
    <ul>
    <li><a target="commons" href="<?= $media['descriptionshorturl'] ?>">commons.wikimedia.org</a></li>
    <li><a target="commons" href="//en.wikipedia.org/wiki/<?=
        Tools::categoryUrlencode($media['title']) ?>">en.wikipedia.org</a></li>
    <li><a target="commons" href="//wikidata.org/wiki/<?=
...
<p><em>Media info:</em>
<ul>
<li>width x height: <b><?= number_format((float) $media['width']); ?>
...
?>
<li>timestamp: <b><?= $media['timestamp'] ?></b></li>
<li>uploader: <b>User:<?= $media['user'] ?></b></li>
<li>SHA1 Hash: <small><b><?= $media['sha1'] ?></b></small></li>
</ul>
</p>

<br />
<p><a href="<?= Tools::url('contact') . '?r=' . $media['pageid'] ?>" style="color:#ff9999;">REPORT this file</a></p>
<?php
if (Tools::isAdmin()) {
