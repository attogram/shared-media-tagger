...
<?php } else { ?>
<link rel="stylesheet"
    href="<?= Tools::url('home') ?>bootstrap/css/bootstrap.min.css">
<?php } ?>
<style>
...
<?php } else { ?>
<xxscript src="<?= Tools::url('home') ?>jquery.min.js"></xxscript>
<script src="<?= Tools::url('home') ?>bootstrap/js/bootstrap.min.js"></script>
<?php } ?>
