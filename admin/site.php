...
. '<div style="font-weight:bold; font-size:120%; color:black; background-color:yellow; padding:2px;">'
. $site['name'] . '</div>'
...
foreach( $tags as $tag ) {
	...
	. '<td><input name="name" value="' . $tag['name'] . '" size="12" /></td>'
	. '<td><input name="display_name" value="' . $tag['display_name'] . '" size="12" /></td>'
